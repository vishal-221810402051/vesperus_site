...
export default function NovaScContactCta() {
  return (
    <section className="section-shell">
      <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }} className="panel p-6 text-center md:p-10">
        ...
        <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-semibold md:text-5xl">Interested in supervision and validation infrastructure?</h2>
        <p className="mx-auto mt-5 max-w-2xl leading-8 text-text-secondary">
          For innovation ecosystems, incubators, technical collaborators, and early partners interested in NOVA SC supervision, telemetry validation, and future intelligent advisory infrastructure, contact Vesperus.
        </p>
        <Link
          to="/contact"
