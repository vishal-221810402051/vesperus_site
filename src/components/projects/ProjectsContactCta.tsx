  ...
  return (
    <section className="section-shell">
      <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }} className="panel p-6 text-center md:p-10">
        ...
        <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-semibold md:text-5xl">Interested in validation-first medical automation infrastructure?</h2>
        <p className="mx-auto mt-5 max-w-2xl leading-8 text-text-secondary">
          Vesperus is open to conversations with innovation ecosystems, incubators, technical collaborators, and early partners.
        </p>
        <Link
          to="/contact"
